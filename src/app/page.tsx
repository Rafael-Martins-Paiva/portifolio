            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Trabalhei em uma variedade de projetos, desde sites até aplicações web complexas. Aqui estão alguns dos meus favoritos.
                </p>
              </div>
            </div>
          </BlurFade>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  {DATA.hackathons.length}+ hackathons, com pessoas conhecidas e outras totalmente novas para mim,, 
